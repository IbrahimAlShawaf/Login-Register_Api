...
import '../../constant/code_text_field.dart';
...
class _ResetPasswordScreenState extends State<ResetPasswordScreen>
  ...
  Future<void> _resetPassword() async {
    ...
    UserModel response = await AuthController().resetPassword(
         code: _code, password: _passwordConfirmationTextController.text, email: widget.email,
        );
    if (response.status!) {
